      ...
      {result ? (
        <div className="space-y-8 animate-in fade-in duration-700">
          ...
          <motion.div
            ...
            className="aspect-video dashboard-heatmap-container cursor-zoom-in group/heatmap relative"
          >
            <motion.img
          ...
          <div className="absolute top-20 left-20 z-[60] flex items-center justify-center p-4 md:p-6">
            ...
            >
              ...
              <div className="dashboard-modal-header">
                <div className="space-y-1">
                  <h3 className="dashboard-modal-title heading-font tracking-tight">{zoomedImage.model} Analysis</h3>
                  <p className="dashboard-panel-title opacity-40">Forensic Attention Map</p>
                </div>
                <button
                  onClick={() => setZoomedImage(null)}
              ...
              <div className="px-10 pb-10">
                <div className="dashboard-modal-img-container">
                ...
                >
                  ...
                  <p className="dashboard-panel-title opacity-30">Secure Biometric Scan</p>
                  <div className="h-px w-8 bg-current opacity-10" />
                </motion.div>
              </div>
            </motion.div>
